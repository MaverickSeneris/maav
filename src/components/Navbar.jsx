...
export default function Navbar({
  ...
  useEffect(() => {
    const totalItemsPrice = bag.reduce(
  ...
  const totalItemPrice = bag.reduce(
    ...
    <div className="navbar">
      ...
      <div className="right">
        ...
        {isLoggedIn && (
          ...
          >
            <div className="user-initial">{username[0].toUpperCase()}</div>
            {showMessage && (
